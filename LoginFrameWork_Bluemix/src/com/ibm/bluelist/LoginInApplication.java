...
public final class LoginInApplication extends Application {
	...
	private static final String CLASS_NAME = LoginInApplication.class
			.getSimpleName();
	List<UserItem> itemList;

	public LoginInApplication() {
	...
	public void onCreate() {
		super.onCreate();
		itemList = new ArrayList<UserItem>();
